...
/**
* KTCosNMS/xAGWPackage/stKtAgwAlarmCurrentResp.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../../../src/main/resources/idl/KTCosNMS.idl
* 2022 12 11 Ͽ  6 10 50 KST
*/

public final class stKtAgwAlarmCurrentResp implements org.omg.CORBA.portable.IDLEntity
{
  ...
  public stKtAgwAlarmCurrentResp ()
  {
  } // ctor

  public stKtAgwAlarmCurrentResp (short _agwType, String _agwId, int _alarmId, short _severity, short _correlationFlag, String _connectedEx, short _tid, short _ssid, short _oid, short _rid, short _sid, short _cid, short _lid, String _date)
  {
    agwType = _agwType;
    agwId = _agwId;
    alarmId = _alarmId;
