...
/**
* KTCosNMS/xAGWPackage/StringStHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ../corba_test/BcNNMS_AGW.idl
*/

abstract public class StringStHelper
{
  private static String  _id = "IDL:KTCosNMS/xAGW/StringSt:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (KTCosNMS.xAGWPackage.StringStHelper.id (), "StringSt", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    KTCosNMS.xAGWPackage.StringSt value = new KTCosNMS.xAGWPackage.StringSt ();
