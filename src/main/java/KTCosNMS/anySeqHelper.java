...
{
  private static String  _id = "IDL:KTCosNMS/anySeq:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (KTCosNMS.anySeqHelper.id (), "anySeq", __typeCode);
    }
    return __typeCode;
  }
